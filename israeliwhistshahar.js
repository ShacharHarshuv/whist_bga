    ...
    return declare('bgagame.israeliwhistshahar', ebg.core.gamegui, {
        ...
        */
        ...
        setup: function (gamedatas) {
            ...
            this.createGameAreaHTML(gamedatas);
        ...
        createGameAreaHTML: function (gamedatas) {
            ...
            var gameArea = this.getGameAreaElement();

            // Create player tables for each player
            var playerPositions = ['S', 'W', 'N', 'E']; // South, West, North, East
            var playerIds = Object.keys(gamedatas.players);

            for (var i = 0; i < playerIds.length; i++) {
                var player_id = playerIds[i];
