 ...
 * heartstesting.js
 *
 * HeartsTesting user interface script
 *
...
function (dojo, declare) {
    return declare("bgagame.heartstesting", ebg.core.gamegui, {
        constructor: function(){
            console.log('heartstesting constructor');
        ...
        */
        ...
        /*
            ...
            Note: game notification names correspond to "notifyAllPlayers" and "notifyPlayer" calls in
                  your heartstesting.game.php file.
